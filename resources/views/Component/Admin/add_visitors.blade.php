...
<div class="page-header">
    <div>
        ...
        <div class="sub-title">Register a new visitor entry</div>
    </div>
...
<div class="form-wrapper">
    ...
    <div class="info-box">
        ...
        <div class="info-text">
            <strong>Note:</strong> Check-in time will be automatically recorded as the current time.
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('visitor_name') is-invalid @enderror" 
                       id="visitor_name" name="visitor_name" value="{{ old('visitor_name') }}" 
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <select class="form-control @error('purpose_of_visit') is-invalid @enderror" 
                    ...
                    <option value="Meeting" {{ old('purpose_of_visit') == 'Meeting' ? 'selected' : '' }}>Meeting</option>
                    <option value="Visit Student" {{ old('purpose_of_visit') == 'Visit Student' ? 'selected' : '' }}>Visit Student</option>
                    ...
                    <option value="Interview" {{ old('purpose_of_visit') == 'Interview' ? 'selected' : '' }}>Interview</option>
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('student_room') is-invalid @enderror" 
                       id="student_room" name="student_room" value="{{ old('student_room') }}" 
        ...
        <div class="form-row">
            <div class="form-group">
                ...
                <input type="datetime-local" class="form-control @error('check_in_time') is-invalid @enderror" 
                       id="check_in_time" name="check_in_time" value="{{ old('check_in_time', date('Y-m-d\TH:i')) }}">
                @error('check_in_time')
                    <span class="invalid-feedback">{{ $message }}</span>
                @enderror
            </div>
...
<script>
    $(document).ready(function() {
        // Set default check-in time to current time if empty
        if (!$('#check_in_time').val()) {
            ...
            $('#check_in_time').val(`${year}-${month}-${day}T${hours}:${minutes}`);
        }

        // Auto-fill student room when student name is entered (optional)
        // You can implement AJAX to fetch student room if needed
